  ...
  return (
    <div className='w-full flex py-4 sticky top-0 z-10 bg-white justify-between gap-10'>
      ...
      <div className='flex items-center font-bold font-instrument-sans text-lg space-x-5'>
        ...
        <Link href='/news'><div className='cursor-pointer'>News</div></Link>
        {session ? (
          <div className='relative'>
            ...
            >
              <div className='flex items-center'>
                {session.user?.image ? <img src={session.user.image} alt={session.user?.username} className='w-8 h-8 bg-logo rounded-full bg-contain' /> : <div
